...
Every Visual element implementation can be replaced by a custom one, given in the model it self the `customImplementation`
flag has been set for an element.
