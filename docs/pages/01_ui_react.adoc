...
Be aware that navigating via associations breaks the reference "chain" therefore in such cases the latest view data will
always be the current view's data.
