...
import { DropdownButton, MdiIcon, TooltipContent, useJudoNavigation } from '~/components';
import { useConfirmDialog } from '~/components/dialog';
import { AssociationButton, DebouncedNumericInput, DebouncedTextField, Tags } from '~/components/widgets';
...
export default function ViewGalaxyView(props: ViewGalaxyViewProps) {
  ...
  return (
    <Grid
      container
      data-testid="God/(esm/_YTr-YE7rEeycO-gUAWxcVg)/TransferObjectViewPageContainer"
      sx={{ width: '100%' }}
    >
      <Grid
        data-testid="God/(esm/_YTr-YE7rEeycO-gUAWxcVg)/TransferObjectViewVisualElement"
        data-name="View"
        size={{ xs: 12, sm: 12, md: 36.0 }}
      >
        <Grid container direction="row" spacing={2}>
          <Grid size={{ xs: 12, sm: 12 }}>
            ...
            >
              <Grid
                data-testid="God/(esm/_CtcuYE7uEeycO-gUAWxcVg)/GroupVisualElement"
                data-name="group"
                size={{ xs: 12, sm: 12 }}
              >
                <Grid container direction="row" spacing={2}>
                  <Grid size={{ xs: 12, sm: 12 }}>
                    ...
                    >
                        ...
                        >
                          ...
                          <AccordionDetails sx={{ px: 3 }}>
                            <Grid container alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                              <Grid size={{ xs: 12, sm: 12, md: 24.0 }}>
                                <Grid container direction="row" spacing={2}>
                                  <Grid size={{ xs: 12, sm: 12 }}>
                                    <Grid
                                      data-testid="God/(esm/_8AxbAE7tEeycO-gUAWxcVg)/TabularReferenceFieldRelationDefinedTable"
                                      container
                                      direction="column"
                                      alignItems="stretch"
                                      justifyContent="flex-start"
                        ...
                        >
                          ...
                          <AccordionDetails sx={{ px: 3 }}>
                            <Stack spacing={2} className="force-full-width">
                              <Grid
                                data-testid="God/(esm/_YJOJEFjWEeyV2_3ibolaNQ)/GroupVisualElement"
                                data-name="group"
                                size={{ xs: 12, sm: 12 }}
                              >
                                <Grid container direction="row" spacing={2}>
                                  <Grid size={{ xs: 12, sm: 12 }}>
                                    <Grid
                                      ...
                                      spacing={2}
                                    >
                                      <Grid size={{ xs: 12, sm: 12, md: 8.0 }}>
                                        <DebouncedTextField
                                          required={
                                            actions?.isNameRequired ? actions.isNameRequired(data, editMode) : true
                                          }
                                          name="name"
                                          data-testid="God/(esm/_8Ad5AE7tEeycO-gUAWxcVg)/StringTypeTextInput"
                                          ...
                                          onDebouncedChange={(value: string | null) => {
                                            storeDiff('name', value);
                                          }}
                                        ...
                                        <FormControl error={!!validation.get('real')}>
                                          <FormGroup>
                                            <FormControlLabel
                                              ...
                                              control={
                                                <Checkbox
                                                  data-testid="God/(esm/_V0npMFjWEeyV2_3ibolaNQ)/BooleanTypeCheckbox"
                              ...
                              <Grid size={{ xs: 12, sm: 12, md: 8.0 }}>
                                <DebouncedTextField
                                  ...
                                  name="constellation"
                                  data-testid="God/(esm/_gT1p0FjFEeyV2_3ibolaNQ)/StringTypeTextInput"
                                  label={
                              ...
                              <Grid size={{ xs: 12, sm: 12, md: 8.0 }}>
                                <DebouncedNumericInput
                                  ...
                                  name="magnitude"
                                  data-testid="God/(esm/_gT2Q4FjFEeyV2_3ibolaNQ)/NumericTypeVisualInput"
                                ...
                                <FormControl error={!!validation.get('nakedEye')}>
                                  <FormGroup>
                                    <FormControlLabel
                                      ...
                                      control={
                                        <Checkbox
                                          data-testid="God/(esm/_gT238FjFEeyV2_3ibolaNQ)/BooleanTypeCheckbox"
                              ...
                              <Grid size={{ xs: 12, sm: 12, md: 8.0 }}>
                                <DebouncedTextField
                                  ...
                                  name="originOfName"
                                  data-testid="God/(esm/_gT3fAFjFEeyV2_3ibolaNQ)/StringTypeTextArea"
                                  label={
                      ...
                      <Grid
                        data-testid="God/(esm/_0LmPoBMbEe2_DOUDKkB20Q)/GroupVisualElement"
                        data-name="Discoverer"
                        size={{ xs: 12, sm: 12 }}
                      >
                        <ComponentProxy
                          ...
                          >
                            <CardContent>
                              ...
                              <Grid container alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                                <Grid size={{ xs: 12, sm: 12, md: 4.0 }}>
                                  <DateTimePicker
                                    data-testid="God/(esm/_conRABMcEe2_DOUDKkB20Q)/TimestampTypeDateTimeInput"
                                    ampm={false}
                                    ampmInClock={false}
                                    className={clsx({
                                      'JUDO-viewMode': !editMode,
                                    ...
                                    {...(actions.getDiscoveredValidationProps
                                      ? actions.getDiscoveredValidationProps(data)
                                      : {})}
                                  />
                                </Grid>

                                <Grid
                                  data-testid="God/(esm/_conRARMcEe2_DOUDKkB20Q)/TabularReferenceFieldRelationDefinedLink"
                                  size={{ xs: 12, sm: 12, md: 4.0 }}
                                >
                      ...
                      <Grid
                        data-testid="God/(esm/_KkOiwFjFEeyV2_3ibolaNQ)/GroupVisualElement"
                        data-name="group_3"
                        size={{ xs: 12, sm: 12 }}
                      >
                        <Card data-testid="God/(esm/_KkOiwFjFEeyV2_3ibolaNQ)/GroupVisualElement" data-name="group_3">
                          <CardContent>
                            <Grid
                              container
                              direction="row"
                            ...
                            <Grid container alignItems="flex-start" justifyContent="flex-start" spacing={2}>
                              <Grid size={{ xs: 12, sm: 12, md: 2.0 }}>
                                <AssociationButton
                                  id="God/(esm/_8A3hoE7tEeycO-gUAWxcVg)/TabularReferenceFieldButton"
                                  variant={undefined}
                                  editMode={editMode}
                                  startIcon={<MdiIcon path="chart-bubble" />}
                                  navigateAction={actions.matterOpenPageAction}
                                  refreshCounter={refreshCounter}
                                >
                                  {t('View.Galaxy.View.matter', { defaultValue: 'Matter' })}
                                </AssociationButton>
                              </Grid>
                              ...
                              <Grid size={{ xs: 12, sm: 12, md: 2.0 }}>
                                <DebouncedNumericInput
                                  ...
                                  name="darkMatter"
                                  data-testid="God/(esm/_8Aj_oE7tEeycO-gUAWxcVg)/MeasuredTypeInput"
                              ...
                              <Grid size={{ xs: 12, sm: 12, md: 2.0 }}>
                                <DebouncedNumericInput
                                  ...
                                  data-testid="God/(esm/_8AoREE7tEeycO-gUAWxcVg)/MeasuredTypeInput"
                                  label={
                              ...
                              <Grid size={{ xs: 12, sm: 12, md: 2.0 }}>
                                <DebouncedNumericInput
                                  ...
                                  data-testid="God/(esm/_8AtJkE7tEeycO-gUAWxcVg)/MeasuredTypeInput"
                                  label={
