...
- **ActionGroupTest**: FAB button groups with various configurations (single button, SpeedDial, hybrid, alignment variants)

**Key Helpers**: `UiPageContainerHelper.containerHasFabButtonGroups()`, `UiPageContainerHelper.getFabButtonGroupsForContainer()`, `UiPageContainerHelper.getNonFabDefaultButtonGroupForContainer()`, `UiPageContainerHelper.getNonFabDefaultButtonsForContainer()`, `UiPageContainerHelper.getNonFabNonDefaultButtonGroupsForContainer()`, `UiWidgetHelper.fabAlignmentCss()`

**Templates**: `actor/src/containers/widget-fragments/fab-button-group.fragment.hbs`
